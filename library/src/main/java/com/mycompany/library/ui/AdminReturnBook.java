...
public class AdminReturnBook extends javax.swing.JFrame {
    ...
    // 抓取userid
    AdminReturnBook(String userId,String adminId) {
        this.userId = userId;
    ...
    private void initializeUI() {
        ...
        borrowColumn.setCellRenderer(new AdminReturnBook.ButtonRenderer());
        borrowColumn.setCellEditor(new AdminReturnBook.ButtonEditor(new JCheckBox(), "還書"));
    ...
    private void populateTable(List<Book> books) {
        for (Book book : books) {
            String buttonText = book.isBorrowed() ? "還書" : "未借閱";
    ...
    private class ButtonRenderer extends JButton implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            boolean isBorrowed;
            if(isBorrowed = value != "還書"){
                setForeground(Color.BLACK);
                setEnabled(isBorrowed=false);
            }else{
                setForeground(Color.RED);
                setEnabled(isBorrowed=true);
            }
    ...
    private class ButtonEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Long bookId = (Long) bookTable.getValueAt(row, 0);
            
            if (isBorrowed) {
                BorrowRecordRepository borrowRecordRepository = new BorrowRecordRepository();
                borrowRecordRepository.updateturnStatus(userId, bookId, false); // 设置为已归还
                loadBooks(); // 重新加载书籍列表
            }
