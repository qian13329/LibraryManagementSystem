 ...
 * @author user
 */
public class CheckFineUI extends javax.swing.JFrame {
private String adminId;
private String userId;
    /**
     * Creates new form CheckUser
     */
    public CheckFineUI(String adminId) {
                ...
                if (isValidUserId(userId)) { // 檢查使用者ID是否有效
                    if(checkFine(userId)>0){
                      openFineFrame(userId,adminId);
                        ...
                        JOptionPane.showMessageDialog(CheckFineUI.this, "無須繳納罰金");
                        openIndexFrame(adminId);
                    }
                } else {
                    jTextField1.setText("");
                    JOptionPane.showMessageDialog(CheckFineUI.this, "ID輸入錯誤，請重試！", "錯誤", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(CheckFineUI.this, "請輸入ID", "錯誤", JOptionPane.ERROR_MESSAGE);
            }
        });
        }
